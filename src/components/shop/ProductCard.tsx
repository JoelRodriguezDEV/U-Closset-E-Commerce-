...
export default function ProductCard({
  ...
  return (
    <Link to={`/shop/${product.id}`} className="group cursor-pointer block">
      <div className="group cursor-pointer">
        ...
        <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-gray-100 dark:bg-zinc-800 mb-4">
          ...
          <button className="absolute bottom-4 right-4 bg-white dark:bg-black text-black dark:text-white p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black">
            <Plus size={20} />
          </button>
        </div>
